...
export const geminiSystemInstructions = {
  ...
  wordFinder: `Help the user explore a specific word. Provide a simple definition, three example sentences, synonyms, antonyms, and highlight its usage in different contexts. Use very easy way and English level, use A1 level`,
